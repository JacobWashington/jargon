...
module.exports = (sequelize, DataTypes) => {
  class registeredUser extends Model {
    ...
    static associate(models) {
      models.registeredUser.belongsToMany(models.userprofile, {
  ...
  registeredUser.addHook("beforeCreate", (pendingUser) => {
    // pendingUser is object that gets passed to DB
  ...
  registeredUser.prototype.validPassword = function (typedPassword) {
